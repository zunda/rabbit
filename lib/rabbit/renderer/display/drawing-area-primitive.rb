...
puts "signal_connect_after: map #{__FILE__}"
            mapped(widget)
          end
        end
...
puts "signal_connect: draw #{__FILE__}"
...
puts "signal_connect: expose_event #{__FILE__}"
...
puts "signal_connect_after: window_state_event #{__FILE__}"
